...
// console.log(currencyList['AFA']);
let optionList = document.querySelector("#country_table");
// optionList.innerHTML = "";
for (const key in currencyList) {
    // console.log(key);
    if (Object.hasOwnProperty.call(currencyList, key)) {
        // const element = object[key];
        let newCurrencyList = document.createElement("tr");
        ...
        tableRow1.appendChild(node);
        tableRow2.appendChild(node1);
        tableRow3.appendChild(node2);
        newCurrencyList.appendChild(tableRow1);
        newCurrencyList.appendChild(tableRow2);
        newCurrencyList.appendChild(tableRow3);
        // newCurrencyList.value = `${key}`;
        optionList.appendChild(newCurrencyList);
    // optionList.classList.add('form-select');
}
